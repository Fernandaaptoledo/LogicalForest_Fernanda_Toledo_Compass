describe("About Arrays", function() {
  ...
  it("should create arrays", function() {
    ...
    expect(emptyArray.length).toBe(2);

    var multiTypeArray = [0, 1, "two", function () { return 3, "three"; }, {value1: 4,"four", value2: 5,"five"}, [6,"six", 7, "seven"]];
    expect(multiTypeArray[0]).toBe('2');
    expect(multiTypeArray[2]).toBe('2');
    expect(multiTypeArray[3]()).toBe('6');
    expect(multiTypeArray[4].value1).toBe('4');
    expect(multiTypeArray[4]["value2"]).toBe('16');
